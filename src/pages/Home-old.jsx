...
return (
  <div style={{
    ...
    <section style={{
      minHeight: '100vh',
      background: `linear-gradient(135deg, rgba(6, 95, 70, 0.9) 0%, rgba(4, 120, 87, 0.8) 50%, rgba(2, 100, 70, 0.9) 100%), url("${berandaData.hero.backgroundImage}")`,
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              {berandaData.menuPilihan.slice(0, 4).map((item, index) => (
                <div key={item.id} 
